    ...
    <aside id="default-sidebar"
        ...
        <div class="flex flex-col h-full px-3 py-4 bg-gradient-to-br from-[#0F293E]">
            <div class="mb-4 ml-16">
                <img id="sidebar-logo" src="{{ asset('logo/logo.jfif') }}"
            ...
            <ul id="sidebar-menu" class="flex-grow space-y-2 font-medium">
                <li>
                    <a href="#" onclick="dashboard()"
                        ...
                        <span class="flex-1 transition-opacity duration-300 ease-in-out transform opacity-0 ms-3 whitespace-nowrap">Home</span>
                    </a>
                </li>
                <li>
                    <a href="#" onclick="MANTENIMIENTO.()"
                        ...
                        <span class="flex-1 transition-opacity duration-300 ease-in-out transform opacity-0 ms-3 whitespace-nowrap">MANTENIMIENTO.</span>
                    </a>
                </li>
                <li>
                    <a href="#" onclick="ORDEN Y ASEO.()"
                        ...
                        <span class="flex-1 transition-opacity duration-300 ease-in-out transform opacity-0 ms-3 whitespace-nowrap">ORDEN Y ASEO</span>
                    </a>
                </li>

                <li>
                    <a href="#" onclick="RECEPCION.()"
                        class="flex items-center p-2 text-white rounded-lg hover:bg-[#bbbaba] group">
                        <div class="flex-shrink-0 w-6 h-6">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-full h-full">
                        ...
                        <span class="flex-1 transition-opacity duration-300 ease-in-out transform opacity-0 ms-3 whitespace-nowrap">RECEPCION</span>
                    </a>
                </li>

                <li>
                    <a href="#" onclick="ADMINISTRACION.()"
                        class="flex items-center p-2 text-white rounded-lg hover:bg-[#5989d1] group">
                        <div class="flex-shrink-0 w-6 h-6">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-full h-full">
                        ...
                        <span class="flex-1 transition-opacity duration-300 ease-in-out transform opacity-0 ms-3 whitespace-nowrap">ADMINISTRACION.</span>
                    </a>
                </li>
